...
Revision ID: fbb27ebe89a0
Revises:
Create Date: 2025-06-12 00:20:32.988226
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("error_message", sa.String(length=20), nullable=False),
        ...
        sa.Column("estimated_completion_time", sa.DateTime(), nullable=False),
